...
class StandardRobot(Robot):
    ...
    def updatePositionAndClean(self):
        ...
        if self.room.isPositionInRoom(temp) == 1:
            self.position = temp
...
def runSimulation(num_robots, speed, width, height, min_coverage, num_trials,
    ...
    for num in range(num_trials):
        ...
        while float(new_room.getNumCleanedTiles())/float(new_room.getNumTiles())< min_coverage:
            step += 1   
...
#showPlot1('Time It Takes 1 - 10 Robots To Clean 80% Of A Room','Number of robots','Time_steps')
...
#showPlot2('Time It Takes Two Robots To Clean 80% Of Variously Shaped Rooms','Aspect_ratio','Time_steps')
# === Problem 5
#
