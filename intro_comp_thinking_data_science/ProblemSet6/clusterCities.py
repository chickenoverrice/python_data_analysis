...
class Cluster(object):
    ...
    def singleLinkageDist(self, other):
        ...
        for point_1 in self.points:
            for point_2 in other.points:
                ans.append(point_1.distance(point_2))
        return min(ans)                        
...
class ClusterSet(object):
    ...
    def mergeClusters(self, c1, c2):
        ...
        self.add(Cluster(ans,c1.pointType))        
...
def readCityData(fName, scale = False):
    ...
    dataFile = open('C:\Users\Zhe\Documents\My Books\MIT6.00.2\ProblemSet6\cityTemps.txt', 'r')
    numFeatures = 0
